                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text("3 items for Example\n User Name",style: TextStyle(
                                        fontSize: 20,fontWeight: FontWeight.w600,color: Colors.black,
                                      ),),
                                      Text("Restaurant Name. Location Name .#12ordernumber64",
                                          style:TextStyle(
                                              fontSize: 16,
                                              color: Colors.black,
                                              fontWeight: FontWeight.w500),
                                      ...
                                      ListTile(
                                        ...
                                        title: Divider(),
                                        trailing: Text("CA\$36.98",
                                          style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500,color: Colors.black),
                                        ),
                                      ),
                                      ListTile(
                                        leading: Text("Order Completed",
                                          style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16,color: Colors.black),
                                        ),
                                        title: Divider(),
                                        trailing: Text("24 Feb 12:54AM",
