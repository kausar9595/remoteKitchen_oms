...
class ScheduledOrder extends StatefulWidget {
  ...
  const ScheduledOrder({super.key, required this.orders, required this.onClick, required this.isLoading});
              ...
              child: ListView.builder(
                ...
                itemBuilder: (_, index){
                  ...
                  return OrderListView(
                    ...
                    orderType: data.orderitemSet![0].modifiers!.isNotEmpty ? data.orderitemSet![0].modifiers![0].toString() : "",
