...
class _OrderDetailState extends State<OrderDetail> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: Row(
        children: [
          Expanded(flex: 1, child: CustomerInfo(orderResult: widget.orderResult)),
          Expanded(
            flex: 1,
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Center(
                    child: Text(
                      "${widget.orderResult.quantity} items for ${widget.orderResult.customer}",
                  ...
                  ListTile(
                    ...
                    title: Divider(),
                    trailing: Text(
                      "CA\$${widget.orderResult.subtotal}",
                      style: TextStyle(
                        fontSize: normalFontSize,
                        fontWeight: FontWeight.w400,
                        color: AppColors.textblack,
                  ...
                  ListTile(
                    ...
                    title: Divider(),
                    trailing: Text(
                      "CA\$${widget.orderResult.tax}",
                      style: TextStyle(fontWeight: FontWeight.w400, fontSize: normalFontSize, color: AppColors.textblack),
                    ),
                  ),
                  widget.orderResult.discount != 0.0
                      ? ListTile(
                          leading: Text(
                            "Discount",
                          ...
                          title: Divider(),
                          trailing: Text(
                            "CA\$${widget.orderResult.discount}",
                            style: TextStyle(fontWeight: FontWeight.w500, fontSize: normalFontSize, color: Colors.black),
                          ),
                        )
                      : Center(),
                  widget.orderResult.deliveryFee != 0.0
                      ? ListTile(
                          leading: Text(
                            "Delivery Fee",
                            style: TextStyle(fontWeight: FontWeight.w500, fontSize: normalFontSize, color: Colors.black),
                          ...
                          title: Divider(),
                          trailing: Text(
                            "CA\$${widget.orderResult.deliveryFee}",
                            style: TextStyle(fontWeight: FontWeight.w500, fontSize: normalFontSize, color: Colors.black),
                          ),
                        )
                      : Center(),
                  widget.orderResult.convenienceFee != 0.0
                      ? ListTile(
                          leading: Text(
                            "Convenience Fee",
                            style: TextStyle(fontWeight: FontWeight.w500, fontSize: normalFontSize, color: Colors.black),
                          ...
                          title: Divider(),
                          trailing: Text(
                            "CA\$${widget.orderResult.convenienceFee}",
                            style: TextStyle(fontWeight: FontWeight.w500, fontSize: normalFontSize, color: Colors.black),
                          ),
                        )
                      : Center(),
                  widget.orderResult.deliveryDiscount != 0.0
                      ? ListTile(
                          leading: Text(
                            "Delivery Discount",
                            style: TextStyle(fontWeight: FontWeight.w500, fontSize: normalFontSize, color: Colors.black),
                          ...
                          title: Divider(),
                          trailing: Text(
                            "CA\$${widget.orderResult.deliveryDiscount}",
                            style: TextStyle(fontWeight: FontWeight.w500, fontSize: normalFontSize, color: Colors.black),
                          ),
                        )
                      : Center(),
                  widget.orderResult.voucher != null && widget.orderResult.voucher != 0.0
                      ? ListTile(
                          leading: Text(
                            "Voucher",
                            style: TextStyle(fontWeight: FontWeight.w500, fontSize: normalFontSize, color: Colors.black),
                          ...
                          title: Divider(),
                          trailing: Text(
                            "CA\$${widget.orderResult.voucher}",
                            style: TextStyle(fontWeight: FontWeight.w500, fontSize: normalFontSize, color: Colors.black),
                          ),
                        )
                      : Center(),
                  widget.orderResult.tips != null && widget.orderResult.tips != 0.0
                      ? ListTile(
                          leading: Text(
                            "Tips",
                            style: TextStyle(fontWeight: FontWeight.w500, fontSize: normalFontSize, color: Colors.black),
                                  ...
                                  : currentOrderStatus == OrderStatus.completed
                                      ...
                                      : currentOrderStatus == OrderStatus.cancelled
                                          ...
                                          : currentOrderStatus == OrderStatus.readyForPickup ||
                                                  currentOrderStatus == OrderStatus.schedule && widget.orderResult.orderMethod == "pickup"
                                              ? StatusButton(
                                                  onClick: () {
                                                    appPopup(
                                                        context: context,
