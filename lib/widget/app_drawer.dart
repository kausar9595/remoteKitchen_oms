          ...
          children: [
                    ...
                    : DropdownButtonHideUnderline(
                        child: DropdownButton2<LocationResult>(
                          ...
                          onChanged: (v) {
                            ...
                            RestaurantController.addSelectedLocationInfo(
                                    locationId: _selectedLocationId!.id.toString(), locationName: _selectedLocationId!.name.toString())
                                .then((value) {
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  border: _isOrder ? Border(left: BorderSide(color: AppColors.textindigo, width: 6)) : Border(left: BorderSide.none),
            ...
            InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  border: _isHistory
                      ? Border(
                          left: BorderSide(color: AppColors.textindigo, width: 6),
                        )
                      : Border(left: BorderSide.none),
            ...
            InkWell(
              onTap: () {
                Get.to(IssueOrderScreen(), transition: Transition.rightToLeft);
              },
              child: Container(
                padding: EdgeInsets.only(left: 20),
                alignment: Alignment.centerLeft,
