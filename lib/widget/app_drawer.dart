...
class _AppDrawerState extends State<AppDrawer> {
  ...
  _getLocationAdnRestaurant()async{
    await RestaurantController.getLocationAndRestaurantIds().then((value){
      ...
      if(value.restaurantName != "null" && value.locationName != "null"){
        print("value.locationName! check === ${value.locationName!}");
        ...
        child: Column(
          ...
          children: [
                ...
                Container(
                    ...
                    child: _isRestaurantLoading ? AppShimmer(width: 200)
                      ...
                      child: DropdownButton2<RestaurantResult>(
                        isExpanded: true,
                        hint: Text(
                          '${selectRsname == null ? "Restaurant Select" : selectRsname}',
                          maxLines: 1,
                          style: TextStyle(
                            fontSize: 14,
                ...
                Container(
                    ...
                    child: _isLocationLoading ? AppShimmer(width: 200,)
                      ...
                      child: DropdownButton2<LocationResult>(
                        isExpanded: true,
                        hint: Text(
                          '${ selectLocationName == null ? "Location Select" : selectLocationName }',
                          maxLines: 1,
                          style: TextStyle(
                            fontSize: 14,
                            color: AppColors.textindigo,
            ...
            Container(
              ...
              child: Text(
                '(Test Version ${AppConfig.APP_VERSION})',
